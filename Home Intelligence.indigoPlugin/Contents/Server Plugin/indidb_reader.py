...
Verbatim copy of indigo-mcp-lite's ``indidb_reader.py`` (lite PR #40).
Keep the two copies textually aligned when fixing bugs — the same
keep-aligned contract as ``history_db.py``. See ADR-0010 for why this
is a copy rather than a runtime dependency on lite's MCP tools.
